            ...
            <div className="relative flex items-center justify-center mt-6 mb-8 w-full max-w-[360px] aspect-square">
                ...
                >
                    ...
                    <div className="absolute inset-0 flex flex-col items-center justify-center text-white pointer-events-none text-center z-[200]">
                        ...
                        <span className="font-sans font-black tracking-[0.4em] uppercase text-sm md:text-base mb-[-8px] text-pink-50 drop-shadow-[0_4px_8px_rgba(0,0,0,0.3)]">Happy</span>
                        <span className="font-cursive text-[6rem] md:text-[8rem] text-white py-0 leading-[1] drop-shadow-[0_10px_20px_rgba(150,0,50,0.5)]">Mother's</span>
                        <span className="font-sans font-black tracking-[0.5em] uppercase text-3xl md:text-4xl mt-[-12px] text-pink-50 drop-shadow-[0_4px_8px_rgba(0,0,0,0.3)] z-10">Day</span>
                    </div>
                </motion.div>
            </div>

            <div className="text-center mb-8 z-10">
                <h2 className="text-pink-600 font-display text-2xl md:text-3xl font-bold mb-2">Mom, this is for you!</h2>
                <p className="text-pink-500/90 font-semibold text-sm">A special message just for the best mom.</p>
            </div>
